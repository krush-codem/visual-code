...
export default function HeroSection({ isDark }) {
  return (
    <section className="relative pb-20 px-6 sm:px-8 overflow-hidden">
      {/* Background Gradient */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            Build, visualize, and collaborate in real-time. CodeVisualizer
            transforms your development workflow with live previews, AST
            insights, and seamless team collaboration.
          </p>
        ...
        <div className="mt-20 relative">
          <div
            ...
            style={{
              boxShadow: isDark
                ? "0 25px 50px -12px rgba(0,70,255,0.15)"
